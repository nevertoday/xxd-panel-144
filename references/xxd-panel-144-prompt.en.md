...
Default and precedence: the source’s final amendment selects left–right 7:6, original left and design right, 50:50. An explicitly selected runtime top–bottom mode overrides that amendment and maps left/right back to upper/lower. Apply the final runtime mode and ratio after the entire source; preserve all aesthetic instructions.
